...
function plotBehavior_appended(date, db_trials, saveDir, mouseNum)
...
if size(programNums_to_append,2) > 1
    ...
    % most everything below is a copy from plotBehavior_v2
    % main edit: "ismember(db_trials.programNum,programNums_to_append)" instead
    % of "db_trials.programNum == program"
    % minor edit: fig names and titles
    ...
    odor17_rows = (ismember(db_trials.programNum,programNums_to_append) &...
        matches(db_trials.date, dateToPlot) &...
        db_trials.trialNum_rel > exclude_First_N_Trials &...
        db_trials.odorID == 17);
    odor18_rows = (ismember(db_trials.programNum,programNums_to_append)  &...
        matches(db_trials.date, dateToPlot) &...
        db_trials.trialNum_rel > exclude_First_N_Trials &...
        db_trials.odorID == 18);
    ...
    if trials_odor17_total >= 2 * trials_per_bin &&...
        ...
        figName_prefix = strcat(mouseNum,'_', dateToPlot,...
            '_programs_',programNums,'_',...
            trials_to_analyze.programName(1));
        figName_suffix = "_APPENDED";

        % create performance plot
        figure('name',strcat(figName_prefix, "_APPENDED_vertical"));
        ...
        title(tl,strcat(figName_prefix, figName_suffix),'Interpreter','none');
